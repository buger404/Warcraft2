VERSION 5.00
Begin VB.Form ChooseWindow2 
   AutoRedraw      =   -1  'True
   BackColor       =   &H00404040&
   BorderStyle     =   0  'None
   Caption         =   "ChooseWindow2"
   ClientHeight    =   8340
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   14235
   LinkTopic       =   "Form1"
   MouseIcon       =   "ChooseWindow2.frx":0000
   ...
   End
End
Attribute VB_Name = "ChooseWindow2"
...
DrawTextRect Maps(i).Left + 56, Maps(i).top + 68, "联机战斗", argb(195, 255, 255, 255), StringAlignmentCenter
Next
...
CardWindow.SuperFightButton.Visible = False
Unload Me
End Sub
